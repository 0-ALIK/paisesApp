// To parse this data:
//
//   import { Convert, IPaisAPI } from "./file";
//
//   const iPaisAPI = Convert.toIPaisAPI(json);
//
...
export class Convert {
  public static toIPaisAPI(json: string): IPaisAPI {
      return cast(JSON.parse(json), r("IPaisAPI"));
  }

  public static iPaisAPIToJson(value: IPaisAPI): string {
      return JSON.stringify(uncast(value, r("IPaisAPI")), null, 2);
  }
}
